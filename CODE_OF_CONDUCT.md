...
This Code of Conduct (CoC) outlines the minimum standards for acceptable behavior for all contributors, maintainers, and participants in the **cargo-slide** project, across all platforms including GitHub, Codeberg, and any related communication channels.
...
We fully respect all copyright notices from the original developers. All code and documentation contributed to **cargo-slide** must maintain proper attribution and adhere to the licensing terms defined for the project.
...
By participating in the **cargo-slide** project, you agree to abide by this Code of Conduct.
